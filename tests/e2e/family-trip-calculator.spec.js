...
const SVC_URL = "https://appadaycreator.com/family-trip-calculator/";
const SVC_NAME = "家族旅行費用シミュレーター";

test.describe("家族旅行費用シミュレーター - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("family-trip-calculator");
